...
class TransformControlsGizmo extends Object3D {
  constructor() {
    ...
    matRed.color.set(0xb4213b);

    const matGreen = gizmoMaterial.clone();
    matGreen.color.set(0x188651);

    const matBlue = gizmoMaterial.clone();
    matBlue.color.set(0x0a3272);

    const matWhiteTransparent = gizmoMaterial.clone();
    matWhiteTransparent.color.set(0xe7e7e7);
    ...
    matLineRed.color.set(0xb4213b);

    const matLineGreen = gizmoLineMaterial.clone();
    matLineGreen.color.set(0x188651);

    const matLineBlue = gizmoLineMaterial.clone();
    matLineBlue.color.set(0x0a3272);

    const matLineCyan = gizmoLineMaterial.clone();
    matLineCyan.color.set(0x2a2886);

    const matLineMagenta = gizmoLineMaterial.clone();
    matLineMagenta.color.set(0xb4213b);

    const matLineYellow = gizmoLineMaterial.clone();
    matLineYellow.color.set(0x188651);

    const matLineGray = gizmoLineMaterial.clone();
    matLineGray.color.set(0x939393);

    const matLineYellowTransparent = matLineGray.clone();
